    ...
    <div class="flex flex-col md:flex-row md:items-center justify-between gap-6">
      ...
      <div class="flex items-center gap-3">
        ...
        <button 
          ...
          class="btn-primary shadow-xl shadow-primary/20"
        >
        ...
        <table class="w-full text-left border-collapse">
          ...
          <tbody class="divide-y divide-slate-50">
            <tr v-if="isLoading" v-for="i in 5" :key="i" class="animate-pulse">
              <td colspan="6" class="px-6 py-8 h-16 bg-slate-50/10"></td>
            </tr>

            <tr v-else v-for="p in payrolls" :key="p.id" class="hover:bg-slate-50/30 transition-colors group">
              <td class="px-6 py-5">
                <div class="flex items-center gap-3">
              ...
              <td class="px-6 py-5 text-center text-xs font-medium text-slate-500">
                {{ formatCurrency(p.base_salary) }}
              </td>
              <td class="px-6 py-5 text-center text-xs font-bold text-red-500">
                -{{ formatCurrency(p.deduction) }}
              </td>
              <td class="px-6 py-5 text-center text-sm font-bold text-primary">
            ...
            <tr v-if="!isLoading && payrolls.length === 0">
